...
class Bip69Test extends AbstractTestCase
{
     ...
     */
    public function test_check(Bip69 $bip69, bool $expectedCheck, string $txHex)
    {
     ...
     */
    public function test_inputs_sort(array $vin, array $vexpected)
    {
        $bip69 = new Bip69;
     ...
     */
    public function test_outputs_sort(array $vout, array $vexpected)
    {
        $bip69 = new Bip69;
