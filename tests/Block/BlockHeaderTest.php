...
class BlockHeaderTest extends AbstractTestCase
{
    ...
    public function test_new_header()
    {
    ...
    public function test_get_block_hash()
    {
     ...
     */
    public function test_from_parser_failure()
    {
    ...
    public function test_invalid_merkle_root_size()
    {
    ...
    public function test_invalid_prev_block_size()
    {
    ...
    public function test_invalid_equals()
    {
        $version = 2;
        $merkleRoot = Buffer::hex('4141414141414141414141414141414141414141414141414141414141414141', 32);
        $prevBlock = Buffer::hex('4141414141414141414141414141414141414141414141414141414141414141', 32);
