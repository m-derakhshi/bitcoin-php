...
{
    public function test_script_types()
    {
     ...
     * @throws \Exception
     */
    public function test_two_of_two_with_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = true;
     ...
     * @throws \Exception
     */
    public function test_two_of_two_without_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = false;
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
        $factory = new MultisigScriptDataFactory(2, 2, $sort, $pubKeySerializer);
     ...
     * @throws \Exception
     */
    public function test_two_of_five_without_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = false;
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
     ...
     * @throws \Exception
     */
    public function test_checks_number_of_keys(EcAdapterInterface $ecAdapter)
    {
        $pubKeyFactory = new PublicKeyFactory($ecAdapter);
        $publicKeyHexes = [
            /* 0,0 */ '02e0af92e8fc45a67705704c14102fafe2a32634fdaca494c75cc6165f442b41f9',
     ...
     * @throws \Exception
     */
    public function test_p2sh_multisig_with_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = true;
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
     ...
     * @throws \Exception
     */
    public function test_p2wsh_multisig_with_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = true;
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
     ...
     * @throws \Exception
     */
    public function test_p2sh_p2wsh_multisig_with_sorting(EcAdapterInterface $ecAdapter)
    {
        $sort = true;
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
