...
class MultisigHDTest extends AbstractTestCase
{
     ...
     */
    public function test_always_provides_keys()
    {
        new MultisigHD(new MultisigScriptDataFactory(2, 2, true));
    }

    public function test_key_order_is_preserved()
    {
     ...
     */
    public function test_get_redeem_script(EcAdapterInterface $ecAdapter)
    {
     ...
     * @throws \BitWasp\Buffertools\Exceptions\ParserOutOfRange
     */
    public function test_get_witness_script(EcAdapterInterface $ecAdapter)
    {
        $hdFactory = new HierarchicalKeyFactory($ecAdapter);
        $keys = [
            $hdFactory->fromExtended('xpub661MyMwAqRbcGG5afwSiBJ37bLbnzj9VuCdKzcQgihyuRYbiA1PnhuzWzMg2H9xT7JMHWGowEfx93cxzL7KUsX9Q2hrG2ayhKf93x1uXUsV'),
     ...
     * @throws \BitWasp\Buffertools\Exceptions\ParserOutOfRange
     */
    public function test_get_nested_witness_script(EcAdapterInterface $ecAdapter)
    {
        $hdFactory = new HierarchicalKeyFactory($ecAdapter);
        $keys = [
            $hdFactory->fromExtended('xpub661MyMwAqRbcGG5afwSiBJ37bLbnzj9VuCdKzcQgihyuRYbiA1PnhuzWzMg2H9xT7JMHWGowEfx93cxzL7KUsX9Q2hrG2ayhKf93x1uXUsV'),
     ...
     * @throws \BitWasp\Bitcoin\Exceptions\DisallowedScriptDataFactoryException
     */
    public function test_derive_child(EcAdapterInterface $ecAdapter)
    {
        $hdFactory = new HierarchicalKeyFactory($ecAdapter);
        $pubKeySerializer = EcSerializer::getSerializer(PublicKeySerializerInterface::class, true, $ecAdapter);
        $hd = new MultisigHD(
     ...
     * @dataProvider getEcAdapters
     */
    public function test_initialize_with_root_keys(EcAdapterInterface $ecAdapter)
    {
     ...
     * @dataProvider getEcAdapters
     */
    public function test_test_account_keys_using_slip132(EcAdapterInterface $ecAdapter)
    {
        $btc = NetworkFactory::bitcoin();
