...
{
    public function test_get_op_codes()
    {
        $script = new Script;
    ...
    public function test_pushdata4()
    {
    ...
    public function test_default_serialize_binary()
    {
        $script = new Script;
    ...
    public function test_default_serialize_hex()
    {
        $script = new Script;
    ...
    public function test_serialize_binary()
    {
        $script = new Script;
        $val = $script->getBuffer()->getBinary();
        $this->assertEmpty($val);
    ...
    public function test_serialize_hex()
    {
        $script = new Script;
        $val = $script->getBuffer()->getHex();
        $this->assertEmpty($val);
    ...
    public function test_push_buffer()
    {
     ...
     */
    public function test_op_failure()
    {
        ScriptFactory::create()->op('OP_HASH666');
    }

    public function test_pushdata1()
    {
        $data = Buffer::hex(
    ...
    public function test_pushdata2()
    {
        $data = Buffer::hex(
            '41414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141'.
            '41414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141'.
    ...
    public function test_get_script_hash()
    {
    ...
    public function test_get_var_int()
    {
     ...
     */
    public function test_is_push_only(ScriptInterface $script, bool $eResult)
    {
     ...
     * @param  bool  $valid
     */
    public function test_witness_vectors(ScriptInterface $script, $valid)
    {
        $witness = null;
    ...
    public function test_bad_script_zero_sig_ops()
    {
